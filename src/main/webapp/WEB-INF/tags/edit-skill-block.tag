...
<%@ attribute name="skill" required="false" type="info.windigital.resume.entity.Skill" %>
...
<div id="ui-item-${index}" class="row ui-item skill-item">
    ...
    <div class="col-xs-7 col-sm-8 col-md-10 value-container">
        ...
        <textarea name="items[${index}].value" class="form-control pull-right" required="required"
                  rows="2">${skill.value}</textarea>
    </div>
</div>
